...
public class NodoConstante0_0 extends NodoConstanteAbstracto {

	private static final NodoConstante0_0 INSTANCE = new NodoConstante0_0();

	public static NodoConstante0_0 getInstance() {
//		System.out.println("instanciada 0.0");
		return INSTANCE;
	}
