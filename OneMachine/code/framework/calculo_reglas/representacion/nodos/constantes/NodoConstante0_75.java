...
public class NodoConstante0_75 extends NodoConstanteAbstracto {

	private static final NodoConstante0_75 INSTANCE = new NodoConstante0_75();

	public static NodoConstante0_75 getInstance() {
		return INSTANCE;
	}
