...
public class NodoConstante0_4 extends NodoConstanteAbstracto {

	private static final NodoConstante0_4 INSTANCE = new NodoConstante0_4();

	public static NodoConstante0_4 getInstance() {
		return INSTANCE;
	}
