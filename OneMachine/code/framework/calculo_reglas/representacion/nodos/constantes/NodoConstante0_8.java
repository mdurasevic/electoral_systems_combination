...
public class NodoConstante0_8 extends NodoConstanteAbstracto {

	private static final NodoConstante0_8 INSTANCE = new NodoConstante0_8();

	public static NodoConstante0_8 getInstance() {
		return INSTANCE;
	}
