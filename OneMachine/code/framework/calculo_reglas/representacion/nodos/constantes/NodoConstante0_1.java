...
public class NodoConstante0_1 extends NodoConstanteAbstracto {

	private static final NodoConstante0_1 INSTANCE = new NodoConstante0_1();

	public static NodoConstante0_1 getInstance() {
		return INSTANCE;
	}
