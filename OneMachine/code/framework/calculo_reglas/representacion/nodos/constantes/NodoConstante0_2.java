...
public class NodoConstante0_2 extends NodoConstanteAbstracto {

	private static final NodoConstante0_2 INSTANCE = new NodoConstante0_2();

	public static NodoConstante0_2 getInstance() {
		return INSTANCE;
	}
