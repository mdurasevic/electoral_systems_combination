...
public class NodoConstante0_5 extends NodoConstanteAbstracto {

	private static final NodoConstante0_5 INSTANCE = new NodoConstante0_5();

	public static NodoConstante0_5 getInstance() {
		return INSTANCE;
	}
