...
public class NodoConstante0_9 extends NodoConstanteAbstracto {

	private static final NodoConstante0_9 INSTANCE = new NodoConstante0_9();

	public static NodoConstante0_9 getInstance() {
		return INSTANCE;
	}
