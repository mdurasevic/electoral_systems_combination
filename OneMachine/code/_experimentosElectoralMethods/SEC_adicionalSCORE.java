...
public class SEC_adicionalSCORE {
	...
	public static void main(String[] args) {
		...
		AlgoUtil.iniciaLogger("AnalysisEnsembles_CombinationMethods_" + n + "_" + directorio + "_"
				+ AlgoUtil.gestorReglas.cardinalidadEnsemblesColaborativos + "_" + combinationMethodSEC + "_" + minScore
				+ "_" + maxScore);
		...
		AlgoUtil.vln(ensemble.train() + ";" + ensemble.test() + ";" + (fin - inicio) / 1000 + ";"
				+ ensemble.representaMonticulo());
		AlgoUtil.end();
	}
