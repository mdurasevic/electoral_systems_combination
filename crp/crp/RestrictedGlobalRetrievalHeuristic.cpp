...
void RestrictedGlobalRetrievalHeuristic::fitToRange(vector<double>& values)
{
...
RestrictedGlobalRetrievalHeuristic::RestrictedGlobalRetrievalHeuristic(shared_ptr<ContainerSourceSelectionStrategy> selectionStrategy, shared_ptr<GlobalRetrievalHeuristicSettings> GRHS)
{
...
void RestrictedGlobalRetrievalHeuristic::Solve(ContainerYard& containerYard)
{
