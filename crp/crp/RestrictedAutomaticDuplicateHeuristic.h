...
class RestrictedAutomaticDuplicateHeuristic :
...
public:
	RestrictedAutomaticDuplicateHeuristic(std::string expression1, std::string expression2, ContainerSelectionType selectionType);
